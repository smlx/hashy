...
type GenerateCmd struct {
	Function string `kong:"required,enum='mariaDBOldPassword,md5crypt,sha1crypt',help='Cryptographic hash function (AKA method) used to generate the password hash'"`
